...
public class DetectOutboundContentRule extends Rule	{
	...
	public DetectOutboundContentRule(String contentType, String pattern, String uri) {
		this.setContentType(new UrlPath(contentType, true));
		this.setPattern(new UrlPath(pattern, true));
		this.setUri(new UrlPath(uri, true));	
	}
...
//		}
	...
	public UrlPath getUri() {
		return uri;
	}

	public void setUri(UrlPath uri) {
		this.uri = uri;
	}
