...
import org.demoiselle.waf.business.DetectOutboundContentRuleBC;
...
public class DetectOutboundContentRuleEditMB extends AbstractEditPageBean<DetectOutboundContentRule, Long> {
	...
	public String insert() {
		...
		urlPathBC.insert(detectOutboundContentRule.getContentType());
		urlPathBC.insert(detectOutboundContentRule.getPattern());
		urlPathBC.insert(detectOutboundContentRule.getUri());
