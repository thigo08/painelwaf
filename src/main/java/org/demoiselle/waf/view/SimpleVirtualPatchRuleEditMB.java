...
import org.demoiselle.waf.business.SimpleVirtualPatchRuleBC;
...
public class SimpleVirtualPatchRuleEditMB extends AbstractEditPageBean<SimpleVirtualPatchRule, Long> {
	...
	public String insert() {
		...
		urlPathBC.insert(simpleVirtualPatchRule.getPath());
		urlPathBC.insert(simpleVirtualPatchRule.getValid());
