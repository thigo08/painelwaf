...
import org.demoiselle.waf.business.RestrictContentTypeRuleBC;
...
public class RestrictContentTypeRuleEditMB extends AbstractEditPageBean<RestrictContentTypeRule, Long> {
	...
	public String insert() {
		...
		urlPathBC.insert(restrictContentTypeRule.getAllow());
		urlPathBC.insert(restrictContentTypeRule.getDeny());
