...
import org.demoiselle.waf.business.ReplaceContentRuleBC;
...
public class ReplaceContentRuleEditMB extends AbstractEditPageBean<ReplaceContentRule, Long> {
	...
	public String insert() {
		...
		urlPathBC.insert(replaceContentRule.getPattern());
		urlPathBC.insert(replaceContentRule.getContentType());
